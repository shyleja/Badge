...
void ticket1(int choice,char name[10],int id2,int price)
{
        ...
        printf("\t============================================================\n");
        printf("\t Booking ID : %d \t\t\tShow Name : Deadpool & Wolverine\n",id2);
        printf("\t Customer  : %s\n",name);
        printf("\t\t\t                              Date      : 29-10-2024\n");
        printf("\t                                              Time      : 08:00pm\n");
        printf("\t                                              Hall      : 02\n");
        printf("\t                                              seats No. : %d  \n",choice);
        printf("\t                                              price . : %d  \n\n",price);
...
int movie(void)
{
	...
	printf("\t\t\t----------------------------\n\n");
	printf("\t\t\tpress 1 for Deadpool & Wolverine\n\n");
	printf("\t\t\tpress 2 for Venom: The Last Dance\n\n");
	printf("\t\t\tpress 3 for Terrifier 3\n");
	scanf("%d",&i);
	system("cls");
	return i;
}
void ticket2(int choice,char name[10],int id2,int price)
{
        ...
        printf("\t-----------------THEATER BOOKING TICKET----------------\n");
        printf("\t============================================================\n");
        printf("\t Booking ID : %d \t\t\tShow Name : Venom: The Last Dance\n",id2);
        printf("\t Customer  : %s\n",name);
...
void ticket3(int choice,char name[10],int id2,int price)
{
        ...
        printf("\t-----------------THEATER BOOKING TICKET----------------\n");
        printf("\t============================================================\n");
        printf("\t Booking ID : %d \t\t\tShow Name : Terrifier 3 \n",id2);
        printf("\t Customer  : %s\n",name);
